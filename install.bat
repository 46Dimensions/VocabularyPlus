...
if not defined MAJORPY (
    echo %red%ERROR: Failed to detect Python version.%reset%
    exit /b 1
)
...
echo rem Uninstall
echo if "%%1"=="uninstall" ^(
echo     echo Starting uninstallation...
